...
SECRET_KEY = 'django-insecure-*dosjq(uve66p3h11f&&-+p3&)!hf*j*272vs1ux^6kcp&!fij'
...
MIDDLEWARE = [
    ...
    'web_donuts.custom_middleware.Redirect404ToLoginMiddleware',
]
